...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Schedule.losescore'
        # (to signature: django.db.models.fields.IntegerField(null=True, blank=True))
        db.alter_column('gameday_schedule', 'losescore', orm['gameday.schedule:losescore'])
        
        # Changing field 'Schedule.winscore'
        # (to signature: django.db.models.fields.IntegerField(null=True, blank=True))
        db.alter_column('gameday_schedule', 'winscore', orm['gameday.schedule:winscore'])
