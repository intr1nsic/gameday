...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Schedule.status'
        db.add_column('gameday_schedule', 'status', orm['gameday.schedule:status'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Schedule.status'
        db.delete_column('gameday_schedule', 'status')
